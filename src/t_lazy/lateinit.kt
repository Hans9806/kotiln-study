...
class Person {
    ...
    // 만약 초기값으로 null 을 준다면 해당 프로퍼티를 사용하는 모든 곳에서
    // nullable 과 safe call 을 사용해야하는 문제가 발생
    lateinit var name: String
    // `lateInit` : nullable 로 사용하지 않으면서 초기화를 뒤로 미룰 수 있음
...
fun main() {
    val person = Person()           // name 이 초기화가 되지 않는 시점
